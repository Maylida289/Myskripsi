                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            ...
                            <p style="color: antiquewhite; margin-left: 10px;">
                                <a href="/list-total-tki-blk" style="text-decoration: none; color: antiquewhite;">Total
                                    TKI</a>
                            </p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            ...
                            <p style="color: antiquewhite; margin-left: 10px;">
                                <a href="/list-total-medical-blk" style="text-decoration: none; color: antiquewhite;">Total
                                    Medical</a>
                            </p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            ...
                            <p style="color: antiquewhite; margin-left: 10px;">
                                <a href="/list-total-blk-blk" style="text-decoration: none; color: antiquewhite;">
                                    BLK</a>
                            </p>
                        </div>
                        <div class="icon">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                ...
                                <p style="color: antiquewhite; margin-left: 10px;">
                                    <a href="/list-total-berangkat-blk" style="text-decoration: none; color: antiquewhite;">
                                        Berangkat</a>
                                </p>
                            </div>
                            <div class="icon">

        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ url('operator') }}"> <i class="menu-icon fa fa-dashboard"></i>Dasboard </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ url('pendaftaranp3mi') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Data Total
                            TKI </a>
                    </li>
                    <li>
                        <a href="{{ url('operator') }}"> <i class="menu-icon fa fa-puzzle-piece"></i> Data TKI
                            Pribadi</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->

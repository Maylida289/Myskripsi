        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="progress-container" style="width: 1000px; margin:20px">
                    <a class="step" href="{{ url('status-tki-admin/medical') }}">Medical<br><span>1</span></a>
                    <div class="line"></div>
                    <a class="step" href="{{ url('status-tki-admin/blk') }}">BLK<br><span>2</span></a>
                    <div class="line"></div>
                    <a class="step" href="{{ url('status-tki-admin/validasi') }}">Waiting<br><span>3</span></a>
                    <div class="line"></div>
                    <a class="step" href="{{ url('status-tki-admin/hasil-validasi') }}">Approved<br><span>4</span></a>
                    <div class="line"></div>
                    <a class="step" href="{{ url('status-tki-admin/berangkat') }}">Berangkat<br><span>5</span></a>
                </div>
                        ...
                        <tbody>
                            @foreach ($statusTki as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->sponsor }}</td>
                                    <td>
                                        @if (isset($item->paspor) && isset($item->paspor) && $active === 7)
                                            Approved
                                        @elseif (isset($item->paspor) && isset($item->paspor))
                                            Berangkat
